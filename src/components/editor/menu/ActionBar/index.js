...
export const ActionBar = ({sendData, copyPeerId, saveEditorState, SaveEditorToFile}) => {
    return (
        <div className="dtd-actionBar">
            <h3>Dated.</h3>
            <div className="items">
                <UserButton onClick={sendData}>
                    <input id="companionID" type="text" style={{
                        width: '2rem',
                        border: 'none',
                        borderRadius: '0px',
                        height: '1.5rem',
                ...
                <UserButton onClick={SaveEditorToFile}>
                ...
                <UserButton onClick={saveEditorState}>
